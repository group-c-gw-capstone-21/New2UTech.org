  ...
  <body>
    ...
    <main>
      ...
      <div class="about-us-image">
        <img src="images/success.jpg" alt="People Joining Hands" class="img-responsive"/>
      </div><br>
      <div class="about-us">
        <h3>New2UTech was founded by four college friends that sought out a better way to manage used technology.
          <br><br> ...... this section is still under construction :-)</h3>
        <h2 style="text-align:center"> To contact us, please send an email to: New2UTech@yahoo.com</h2>
      </div>
  </main>
