...
$npo_business_name = $_SESSION["npo_name"];
...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <h2 style="text-align:center">Create Non-Profit Account: Enter Profile</h2>
      <form class="new-account-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          <p style="text-align:justify">Thank you for verifying your non-profit status. Please submit your user account information below to create your account.</p><br>
          <table>
            <tr>
            ...
            <tr>
              <td> <label for="bname"><b>Business Name: </b></label> </td> <td id="bname" name="bname" style="color:red"> <?php echo $npo_business_name; ?></td>
            </tr>
            <tr>
