...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <h2 style="text-align:center">Pending Claim Requests</h2>

      <form class="email-entry" action="New2UTech-ConfirmCancelClaim.php" method="post">
          ...
          <table class="npo-search-resuts-tbl">
            ...
            <?php
              ...
              WHERE Transaction.NPID = $np_trans_id AND Transaction.TransactionStatus = 'Pending'";
          ...
          <br>
            ...
            <table><tr>
              <td>
                ...
                <td>
                  <button class="email-submit-btn" type="submit" name="delete" onclick="return confirm('Are you sure you would like to cancel the claim request on the following selected items?');">Cancel Claim Request</button></td>
                </tr>
            </table>
